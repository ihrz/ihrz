...
client.commands = new Collection(), client.voiceManager = new Collection(), client.invites = new Map(),
  client.interactions = new Collection(), client.register_arr = [], { playerEvents } = require(`${process.cwd()}/files/playerEvents.js`),
