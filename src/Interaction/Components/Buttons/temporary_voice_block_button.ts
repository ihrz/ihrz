				...
				new ActionRowBuilder<UserSelectMenuBuilder>()
					.addComponents(
						new UserSelectMenuBuilder()
							...
							.setPlaceholder(lang.temporary_voice_block_button_menu_placeholder)
							.setMinValues(0)
							.setMaxValues(10)
					)
			]
			...
			await i.reply({
				embeds: [
					new EmbedBuilder()
						...
						.setImage(`https://ihorizon.org/assets/img/banner/ihrz_${await i.client.db.get(`${interaction.guildId}.GUILD.LANG.lang`) || 'fr-FR'}.png`)
