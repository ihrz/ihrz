...
export const subCommand: SubCommand = {
	run: async (
		...
		const hackerDomains = [
			...
			"hackerslair.com",
			"hackerstemple.com",
			"hackerssanctuary.com",
			"hackersasylum.com",
			"hackersretreat.com",
			"hackerssafehouse.com",
			"hackersnest.com",
			"hackerstation.com",
			"hackerstop.com",
			"hackerspot.com",
		...
		const hackerPasswords = [
			...
			"Bl4ckH4tPh4nt0mC0d3!",
			"H4ck3rC0d3Br3ak3r!",
			"Ph4nt0mC0d3M4nH4ck3r!",
			"H4ck3rW1r3l3ssPh4nt0m!",
			"D4rkW3bS3cur1tyPh4nt0m!",
			"Bl4ckH4tPh4nt0mC0d3Br3ak!",
			"H4ck3rPh4nt0mC0d3H3r0!"
		];
		...
		const generatedPassword =
			hackerPasswords[
				Math.floor(crypto.randomInt(0, hackerPasswords.length))
			];

		const embed = new EmbedBuilder()
			.setColor("#800000")
			.setDescription(
				lang.hack_embed_description
					.replace(/\${victim\.id}/g, victim.id)
					.replace(/\${interaction\.user\.id}/g, user.id)
			)
			.addFields(
				{
					name: lang.hack_embed_fields_ip,
					value: `\`${generatedIp}\``
				},
				{
					name: lang.hack_embed_fields_email,
					value: `\`${generatedEmail}\``
				},
				{
					name: lang.hack_embed_fields_password,
