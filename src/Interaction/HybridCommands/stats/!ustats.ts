...
export default {
    run: async (client: Client, interaction: ChatInputCommandInteraction | Message, data: LanguageData, command: SubCommandArgumentValue, execTimestamp?: number, args?: string[]) => {
        ...
        var image = await client.method.imageManipulation.html2Png(htmlContent, { width: 1280, height: 720, scaleSize: 2, elementSelector: '.container', omitBackground: true, selectElement: true });
