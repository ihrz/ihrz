...
export interface LanguageData {
	...
	ticket_panel_no_question_to_delete: string;
	ticket_panel_chose_a_question: string;
	...
	ticket_panel_change_embed_options_chose: string;
	ticket_panel_add_a_question: string;
	ticket_panel_remove_a_question: string;
	ticket_panel_option_invalid: string;
	ticket_panel_chose_option_to_form: string;
	var_chose_option: string;
	ticket_panel_saved_and_sended_panel: string;
	var_title: string;
	var_action: string;
	...
	util_talk_not_in_vc: string;
	util_talk_audit_reason: string;
	util_talk_logs_title: string;
	util_talk_logs_description: string;
	util_talk_command_work: string;
	util_untalk_nothing_active: string;
	util_untalk_audit_reason: string;
	util_untalk_logs_title: string;
	util_untalk_logs_description: string;
	util_untalk_command_work: string;
	util_freeze_logs_title: string;
	util_freeze_logs_description: string;
	util_freeze_command_work: string;
	util_wlvc_no_member: string;
	util_wlvc_no_freeze: string;
	...
	util_unfreeze_command_work: string;
	...
	setjoinmessage_change_image_invalid_url: string;
	...
	perm_edit_roles_command_ok: string;
	...
	var_nm_role_app_dont_exist: string;
	var_nm_role_app_not_high: string;
	var_nm_role_app_not_admin: string;
	var_nm_end_main: string;
	var_nm_start_main: string;
	var_nm_edited_roles: string;
	var_nm_running: string;
	var_nm_stopping: string;
	var_nm_running2: string;
	var_nm_stopping2: string;
	var_nm_title: string;
	var_nm_ping_embed_title: string;
	var_nm_ping_embed_fields_0_name: string;
	var_nm_error_occured: string;
	nightmode_embed_desc: string;
	nightmode_embed_fields_0_name: string;
	nightmode_embed_fields_1_name: string;
	nightmode_embed_fields_2_name: string;
	nightmode_embed_fields_3_name: string;
	nightmode_embed_fields_4_name: string;
	nightmode_select_placeholder: string;
	nightmode_select_0_label: string;
	nightmode_select_0_desc: string;
	nightmode_select_1_label: string;
	nightmode_select_1_desc: string;
	nightmode_select_2_label: string;
	nightmode_select_2_desc: string;
	nightmode_select_3_label: string;
	nightmode_select_3_desc: string;
	nightmode_select_4_label: string;
	nightmode_select_4_desc: string;
	nightmode_select1_placeholder: string;
	nightmode_change_timezone_question: string;
	nightmode_modal_hours_window_fields0_label: string;
	nightmode_modal_hours_window_fields1_label: string;
	nightmode_modal_hours_window_title: string;
	...
	top_messages_title: string;
	top_voice_title: string;
	...
	blogger_generateBlogsEmbed_embed_desc: string;
	blogger_generateBlogsEmbed_embed_title: string;
	blogger_generateConfigurationEmbed_embed_title: string;
	blogger_no_rss: string;
	blogger_generateConfigurationEmbed_embed_fields_1_name: string;
	blogger_generateConfigurationEmbed_embed_fields_2_name: string;
	blogger_unknown_blog: string;
	blogger_on_new_article_default_message: string;
	blogger_config_status_enabled: string;
	blogger_config_status_disabled: string;
	blogger_read_article: string;
	blogger_blog_add_invalid_channel: string;
	blogger_blog_add_success: string;
	blogger_blog_add_invalid_rss: string;
	blogger_blog_remove_success: string;
	blogger_blog_remove_not_found: string;
	lastfm_module_not_configured: string;
	lastfm_config_login_required: string;
	lastfm_config_enabled: string;
	lastfm_config_disabled: string;
	lastfm_login_invalid_session: string;
	lastfm_login_success: string;
	lastfm_embed_title: string;
	lastfm_embed_field_status: string;
	lastfm_embed_field_account: string;
	lastfm_embed_field_connected_at: string;
	lastfm_api_error_login: string;
	lastfm_api_error_nowplaying: string;
	lastfm_api_error_scrobble: string;
	lastfm_api_error_unknown: string;
	...
	rolepanel_setup_embed_title: string;
	rolepanel_setup_embed_desc: string;
	rolepanel_setup_embed_roles_field: string;
	rolepanel_setup_embed_refused_field: string;
	rolepanel_setup_select_placeholder: string;
	rolepanel_setup_apply_button: string;
	rolepanel_setup_no_roles: string;
	rolepanel_setup_saved: string;
	rolepanel_panel_embed_title: string;
	rolepanel_panel_embed_desc: string;
	rolepanel_panel_select_placeholder: string;
	rolepanel_role_managed_or_everyone: string;
	rolepanel_role_too_high_bot: string;
	rolepanel_role_too_high_user: string;
	...
	rolepanel_logs_embed_title_apply: string;
	rolepanel_logs_embed_desc_apply: string;
	...
	help_sticky_fields: string;
	help_sticky_dsc: string;
	sticky_channel_command_error: string;
	sticky_text_command_missing_message: string;
	sticky_text_command_work: string;
	sticky_embed_command_embed_not_found: string;
	sticky_embed_command_work: string;
	sticky_disable_command_not_found: string;
	sticky_disable_command_work: string;
	sticky_refresh_command_not_found: string;
	sticky_refresh_command_missing_embed: string;
	sticky_refresh_command_missing_permissions: string;
	sticky_refresh_command_work: string;
	sticky_show_command_not_found: string;
	sticky_show_embed_title: string;
	sticky_show_embed_fields_channel: string;
	sticky_show_embed_fields_type: string;
	sticky_show_embed_fields_status: string;
	sticky_show_embed_fields_message: string;
	sticky_show_embed_fields_embed: string;
	sticky_show_embed_fields_last_message: string;
	sticky_list_embed_title: string;
	sticky_list_embed_desc_empty: string;
	sticky_list_embed_desc_line_text: string;
	sticky_list_embed_desc_line_embed: string;
	sticky_list_embed_desc_line_text_embed: string;
	sticky_var_text: string;
	sticky_var_embed: string;
	sticky_var_text_embed: string;
	sticky_var_enabled: string;
	sticky_var_disabled: string;
	sticky_var_none: string;
	honeypot_config_not_allowed: string;
	honeypot_config_embed_title: string;
	honeypot_config_embed_desc: string;
	honeypot_config_embed_field_status: string;
	honeypot_config_embed_field_trap_channel: string;
	honeypot_config_embed_field_logs_channel: string;
	honeypot_config_embed_field_action: string;
	honeypot_config_embed_field_message: string;
	honeypot_config_embed_field_notes: string;
	honeypot_config_embed_field_credit: string;
	honeypot_config_notes_value: string;
	honeypot_config_credit_value: string;
	...
	honeypot_config_button_disable: string;
	honeypot_config_send_success: string;
	honeypot_config_enable_success: string;
	...
	honeypot_dm_title: string;
	honeypot_dm_desc: string;
	honeypot_log_title: string;
	honeypot_log_field_author: string;
	honeypot_log_field_channel: string;
	honeypot_log_field_message: string;
	honeypot_log_field_attachments: string;
	...
	tts_leave_disabled: string;
	tts_info_embed_title: string;
	tts_info_embed_description: string;
	tts_info_field_status: string;
	tts_info_field_lang: string;
	tts_info_field_howto: string;
	tts_info_howto_value: string;
	tts_lang_not_active: string;
	tts_lang_set: string;
