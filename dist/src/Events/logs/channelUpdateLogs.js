...
function getDiff(oldChannel, newChannel, lang) {
    let after = "";
...
export const event = {
    ...
    run: async (client, oldChannel, newChannel) => {
        ...
        if (!oldChannel || !oldChannel?.guild)
            return;
        ...
        logsEmbed.setFields({ name: lang.event_srvLogs_messageUpdate_footer_2, value: changes });
