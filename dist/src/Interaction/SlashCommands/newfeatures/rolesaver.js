...
*/
import { EmbedBuilder, ApplicationCommandOptionType, ApplicationCommandType, PermissionsBitField, } from 'discord.js';
    ...
    run: async (client, interaction, lang, command, neededPerm) => {
        ...
        if (action === 'on') {
            let embed = new EmbedBuilder()
                ...
                .addFields({ name: lang.rolesaver_embed_fields_1_name, value: `\`${action}\``, inline: false }, { name: lang.rolesaver_embed_fields_2_name, value: `\`${settings}\``, inline: false }, { name: lang.rolesaver_embed_fields_3_name, value: `\`${timeout}\``, inline: false })
            ...
            let embed = new EmbedBuilder()
                ...
                .addFields({ name: lang.rolesaver_on_off_embed_fields_1_name, value: `\`${action}\``, inline: false })
                .setFooter(await client.method.bot.footerBuilder(interaction));
