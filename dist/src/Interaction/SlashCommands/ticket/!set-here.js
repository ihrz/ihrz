...
*/
import { ActionRowBuilder, ComponentType, PermissionsBitField, StringSelectMenuBuilder, StringSelectMenuOptionBuilder, } from 'discord.js';
...
export default {
    run: async (client, interaction, lang, command, neededPerm) => {
        ...
        let panelCategory = interaction.options.getChannel("category");
        ...
        let comp = new StringSelectMenuBuilder()
            ...
            .setValue("button_panel"), new StringSelectMenuOptionBuilder()
