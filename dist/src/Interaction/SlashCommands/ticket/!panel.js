...
*/
import { ActionRowBuilder, ButtonBuilder, ButtonStyle, ChannelSelectMenuBuilder, ChannelType, ComponentType, EmbedBuilder, PermissionFlagsBits, RoleSelectMenuBuilder, StringSelectMenuBuilder, StringSelectMenuOptionBuilder, TextInputStyle, } from 'discord.js';
...
export default {
    run: async (client, interaction, lang, command, neededPerm) => {
        ...
        let baseData = await client.db.get(`${interaction.guildId}.GUILD.TICKET_PANEL.${panel_id}`) || {
        ...
        let panelSelec2t = new StringSelectMenuBuilder()
            ...
            .setValue("save"), new StringSelectMenuOptionBuilder()
            .setLabel(lang.ticket_panel_panel_2_label)
            .setValue("preview"), new StringSelectMenuOptionBuilder()
            .setLabel(lang.ticket_panel_panel_3_label)
            .setValue("change_embed"), new StringSelectMenuOptionBuilder()
            .setLabel(lang.ticket_panel_panel_4_label)
            .setValue("change_role"), new StringSelectMenuOptionBuilder()
            .setLabel(lang.ticket_panel_panel_5_label)
            .setValue("change_placeholder"), new StringSelectMenuOptionBuilder()
            .setLabel(lang.ticket_panel_panel_6_label)
            .setValue("change_category"), new StringSelectMenuOptionBuilder()
            .setLabel(lang.ticket_panel_panel_10_label)
            .setValue("change_category_2"), new StringSelectMenuOptionBuilder()
            .setLabel(lang.ticket_panel_panel_7_label)
            .setValue("change_ping"), new StringSelectMenuOptionBuilder()
            .setLabel(lang.ticket_panel_panel_8_label)
            .setValue("change_option"), new StringSelectMenuOptionBuilder()
        ...
        const components = [
            new ActionRowBuilder().addComponents(panelSelec2t),
            new ActionRowBuilder().addComponents(panelButton)
        ];
        const originalResponse = await client.method.interactionSend(interaction, {
            embeds: [panelEmbed],
            components
        });
        function stringifyTicketPanelOption(fields) {
        ...
        function stringifyTicketPanelForm(fields) {
            if (!fields || fields?.length === 0)
                return undefined;
            let _ = "```\n";
            let i = 0;
        ...
        async function change_category_for_option(i) {
            ...
            let select = new StringSelectMenuBuilder()
                ...
                .addOptions(...baseData.config.optionFields.map((x, i) => {
        ...
        async function change_placeholder(i) {
        ...
        async function send_embed() {
            ...
            channelCollector.on("collect", async (i) => {
                ...
                let selectMenu = new StringSelectMenuBuilder()
                    ...
                    .addOptions(baseData.config.optionFields.map(x => {
        ...
        async function remove_form() {
            ...
            let select = new StringSelectMenuBuilder()
                ...
                .setPlaceholder(lang.ticket_panel_remove_option_select_placeholder)
                .addOptions(...baseData.config.form.map((x, i) => {
                return new StringSelectMenuOptionBuilder()
