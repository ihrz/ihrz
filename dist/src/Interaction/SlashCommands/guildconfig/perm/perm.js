...
export const command = {
    ...
    async autocomplete(client, interaction) {
        ...
        if (focusedOption.name === 'command') {
            const getCommandChoices = (command, parentName = '') => {
        ...
        const filtered = choices.filter(choice => choice.includes(focusedOption.value) || choice.startsWith(focusedOption.value)).slice(0, 25);
