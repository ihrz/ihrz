...
*/
import { ActionRowBuilder, ButtonBuilder, ButtonStyle, ComponentType, EmbedBuilder, PermissionsBitField, StringSelectMenuBuilder, StringSelectMenuOptionBuilder, TextInputStyle } from 'discord.js';
...
export default {
    run: async (client, interaction, lang, command, neededPerm) => {
        ...
        let ImageBannerOptions = await client.db.get(`${interaction.guild.id}.GUILD.GUILD_CONFIG.joinbanner`);
        let ImageBannerStates = await client.db.get(`${interaction.guild.id}.GUILD.GUILD_CONFIG.joinbannerStates`);
        ...
        let attachment = (await generateJoinImage(interaction.member, { backgroundURL, profilePictureRound, textColour, message, textSize, avatarSize }));
        ...
        if (ImageBannerStates !== "off")
            embeds.push(helpEmbed2) && files.push(attachment);
            ...
            if (buttonInteraction.customId === "joinMessage-set-message") {
                ...
                try {
                    ...
                    if (ImageBannerStates === "on")
                        emb.push(helpEmbed2) && files.push((await generateJoinImage(interaction.member, { backgroundURL: backgroundURL, profilePictureRound, textColour, message, textSize, avatarSize })));
                ...
                let files = [];
                if (ImageBannerStates === "on")
                    emb.push(helpEmbed2) && files.push((await generateJoinImage(interaction.member, { backgroundURL, profilePictureRound, textColour, message, textSize, avatarSize })));
                await message2.edit({ embeds: emb, files: files });
                await client.method.iHorizonLogs.send(interaction, {
                ...
                let stringSelectMenu = new StringSelectMenuBuilder()
                    ...
                    .setValue("change_background"), new StringSelectMenuOptionBuilder()
                    .setLabel(lang.setjoinmessage_change_image_propreties_frame_color)
                    .setValue("change_frame"), new StringSelectMenuOptionBuilder()
                    .setLabel(lang.setjoinmessage_change_image_propreties_text_colour)
                    .setValue("change_text_colour"), new StringSelectMenuOptionBuilder()
                    .setLabel(lang.setjoinmessage_change_image_propreties_text_message)
                    .setValue("change_text_message"), new StringSelectMenuOptionBuilder()
                    .setLabel(lang.setjoinmessage_change_image_propreties_text_size)
                    .setValue("change_text_size"), new StringSelectMenuOptionBuilder()
                    .setLabel(lang.setjoinmessage_change_image_propreties_avatar_size)
                    .setValue("change_avatar_size"));
                let attachment = new ActionRowBuilder().addComponents(stringSelectMenu);
                ...
                i1_collector.on("collect", async (i1) => {
                    if (i1.values[0] === "change_background") {
                        ...
                        let stringSelectMenu = new StringSelectMenuBuilder()
                            ...
                            .setValue("hexProfileColor"), new StringSelectMenuOptionBuilder()
                        ...
                        let attachment2 = (await generateJoinImage(interaction.member, { backgroundURL, profilePictureRound, textColour, message, textSize, avatarSize }));
                        ...
                        let stringSelectMenu = new StringSelectMenuBuilder()
                            ...
                            .setValue("20px"), new StringSelectMenuOptionBuilder()
                            .setLabel(lang.setjoinmessage_var_text_size + "1")
                            .setValue("40px"), new StringSelectMenuOptionBuilder()
                            .setLabel(lang.setjoinmessage_var_text_size + "1.5")
                            .setValue("60px"), new StringSelectMenuOptionBuilder()
                            .setLabel(lang.setjoinmessage_var_text_size + "2")
                            .setValue("80px"), new StringSelectMenuOptionBuilder()
                            .setLabel(lang.setjoinmessage_var_text_size + "3")
                            .setValue("120px"), new StringSelectMenuOptionBuilder()
                        ...
                        let stringSelectMenu = new StringSelectMenuBuilder()
                            ...
                            .setValue("70px"), new StringSelectMenuOptionBuilder()
                            .setLabel(lang.setjoinmessage_var_avatar_size + "1")
                            .setValue("140px"), new StringSelectMenuOptionBuilder()
                            .setLabel(lang.setjoinmessage_var_avatar_size + "1.5")
                            .setValue("210px"), new StringSelectMenuOptionBuilder()
                            .setLabel(lang.setjoinmessage_var_avatar_size + "2")
                            .setValue("280px"), new StringSelectMenuOptionBuilder()
                ...
                textSize = "40px";
                await buttonInteraction.deferUpdate();
                let attachment = (await generateJoinImage(interaction.member, { textSize, backgroundURL, profilePictureRound, textColour, message, avatarSize }));
                await interaction.editReply({ embeds: [helpEmbed, helpEmbed2], files: [attachment], components: [buttons, buttons2] });
                await client.db.set(`${interaction.guildId}.GUILD.GUILD_CONFIG.joinbanner`, { backgroundURL, profilePictureRound, textColour, message, textSize, avatarSize });
            }
