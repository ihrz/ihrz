...
*/
import { EmbedBuilder, TextInputStyle, SnowflakeUtil } from 'discord.js';
...
export default async function (interaction) {
    ...
    if (await interaction.client.db.get(`${interaction.guildId}.GUILD.CONFESSION.disable`))
        return;
    let allDataConfession = await interaction.client.db.get(`${interaction.guildId}.GUILD.CONFESSION`);
    ...
    let view = submitInteraction.fields.getTextInputValue("case_private");
