...
export default async function handleButtonInteraction(interaction) {
    ...
    let comp = new StringSelectMenuBuilder()
        ...
        .addOptions({ label: lang.temporary_voice_privacy_menu_lock_label, description: lang.temporary_voice_privacy_menu_lock_desc, emoji: interaction.client.iHorizon_Emojis.vc.CloseAccess, value: 'temporary_channel_lock_channel_menu' }, { label: lang.temporary_voice_privacy_menu_unlock_label, description: lang.temporary_voice_privacy_menu_unlock_desc, emoji: interaction.client.iHorizon_Emojis.vc.OpenAcces, value: 'temporary_channel_unlock_channel_menu' }, { label: lang.temporary_voice_privacy_menu_invisible_label, description: lang.temporary_voice_privacy_menu_invisible_desc, emoji: interaction.client.iHorizon_Emojis.vc.Unseeable, value: 'temporary_channel_invisible_channel_menu' }, { label: lang.temporary_voice_privacy_menu_visible_label, description: lang.temporary_voice_privacy_menu_visible_desc, emoji: interaction.client.iHorizon_Emojis.vc.Seeable, value: 'temporary_channel_visible_channel_menu' }, { label: lang.temporary_voice_privacy_menu_closechat_label, description: lang.temporary_voice_privacy_menu_closechat_desc, emoji: interaction.client.iHorizon_Emojis.vc.CloseChat, value: 'temporary_channel_closechat_channel_menu' }, { label: lang.temporary_voice_privacy_menu_openchat_label, description: lang.temporary_voice_privacy_menu_openchat_desc, emoji: interaction.client.iHorizon_Emojis.vc.OpenChat, value: 'temporary_channel_openchat_channel_menu' });
    let response = await interaction.reply({
        ephemeral: true,
        components: [new ActionRowBuilder().addComponents(comp)]
    });
