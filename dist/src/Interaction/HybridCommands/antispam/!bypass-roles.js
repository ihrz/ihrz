...
*/
import { ActionRowBuilder, ButtonBuilder, ButtonStyle, ChatInputCommandInteraction, ComponentType, EmbedBuilder, PermissionsBitField, RoleSelectMenuBuilder } from 'discord.js';
export default {
    run: async (client, interaction, lang, command, neededPerm, args) => {
        ...
        ;
        let all_roles = await client.db.get(`${interaction.guildId}.GUILD.ANTISPAM.BYPASS_ROLES`);
