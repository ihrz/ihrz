...
import { getChannelMessagesCount, getChannelMinutesCount, getChannelName, getStatsLeaderboard, } from "../../../core/functions/userStatsUtils.js";
export default {
    run: async (client, interaction, lang, command, neededPerm, args) => {
        ...
        const res = await client.db.get(`${interaction.guildId}.STATS`);
        let memberStats = {};
        let channelStats = {};
        let allMessages = [];
        let allVoiceActivities = [];
