...
export default {
    run: async (client, interaction, lang, command, neededPerm, args) => {
        ...
        let embed = new EmbedBuilder()
            .setAuthor({ name: lang.removemoney_embed_title, iconURL: interaction.member.user.displayAvatarURL() })
            .addFields({ name: lang.removemoney_embed_fields, value: `${amount}$` }, { name: lang.removemoney_embed_second_fields, value: `${bal}$` })
