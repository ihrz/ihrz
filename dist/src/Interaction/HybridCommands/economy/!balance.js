...
export default {
    run: async (client, interaction, lang, command, neededPerm, args) => {
        ...
        ;
        var baseData = await client.db.get(`${interaction.guildId}.USER.${member.id}.ECONOMY`) || { money: 0, bank: 0, ownedRoles: [] };
        ...
        let embed = new EmbedBuilder()
            ...
            .addFields({ name: lang.balance_embed_fields1_name, value: `${baseData.bank || 0}${client.iHorizon_Emojis.icon.Coin}`, inline: true }, { name: lang.balance_embed_fields2_name, value: `${baseData.money || 0}${client.iHorizon_Emojis.icon.Coin}`, inline: true }, { name: lang.var_boost, value: `${possibleBoost}x`, inline: true })
