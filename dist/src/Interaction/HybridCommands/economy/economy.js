...
export function generateRoleFields(roleData, lang) {
...
;
export async function getMemberBoost(member) {
    try {
        let economyConfig = await member.guild.client.db.get(`${member.guild.id}.ECONOMY`);
