...
export default {
    run: async (client, interaction, lang, command, neededPerm, args) => {
        ...
        ;
        let economy = await client.db.get(`${interaction.guildId}.ECONOMY`);
        ...
        const embed = new EmbedBuilder()
            ...
            .setFields({ name: lang.balance_embed_fields1_name, value: `${baseData.bank || 0}${client.iHorizon_Emojis.icon.Coin}`, inline: true }, { name: lang.balance_embed_fields2_name, value: `${baseData.money || 0}${client.iHorizon_Emojis.icon.Coin}`, inline: true }, { name: lang.var_boost, value: `${possibleBoost}x`, inline: true });
