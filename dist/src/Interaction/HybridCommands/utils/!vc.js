...
*/
import { EmbedBuilder, ChannelType, PermissionsBitField, ChatInputCommandInteraction, } from 'discord.js';
export default {
    run: async (client, interaction, lang, command, neededPerm, args) => {
        ...
        if (mode === "large") {
            embed
                .setColor(2829617)
                .setDescription(lang.vc_embed_desc
            ...
            embed
                .setDescription(lang.vc_embed_short_desc
                .replaceAll("${voiceStates?.size}", voiceStates.size.toString())
                .replaceAll("${client.iHorizon_Emojis.icon.iHorizon_Streaming}", client.iHorizon_Emojis.icon.iHorizon_Streaming)
