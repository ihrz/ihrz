...
*/
import { EmbedBuilder, PermissionsBitField, ChatInputCommandInteraction, ChannelType } from 'discord.js';
export default {
    run: async (client, interaction, lang, command, neededPerm, args) => {
        ...
        if (interaction instanceof ChatInputCommandInteraction) {
            var fromChannel = interaction.options.getChannel('from');
            var toChannel = interaction.options.getChannel('to');
