...
export default {
    run: async (client, interaction, lang, command, neededPerm, args) => {
        ...
        if (!description)
            description = lang.profil_not_description_set;
        ...
        if (!age)
            age = lang.profil_unknown;
        var gender = await tableProfil.get(`${member.id}.gender`);
        if (!gender)
            gender = lang.profil_unknown;
        let profil = new EmbedBuilder()
            ...
            .addFields({ name: lang.profil_embed_fields_nickname, value: member.username, inline: false }, { name: lang.profil_embed_fields_money, value: balance + lang.profil_embed_fields_money_value, inline: false }, { name: lang.profil_embed_fields_xplevels, value: level + lang.profil_embed_fields_xplevels_value, inline: false }, { name: lang.profil_embed_fields_age, value: age + lang.profil_embed_fields_age_value, inline: false }, { name: lang.profil_embed_fields_gender, value: `${gender}`, inline: false })
