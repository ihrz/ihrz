...
*/
import { ApplicationCommandOptionType, ActivityType, ApplicationCommandType, ChatInputCommandInteraction } from 'discord.js';
export const command = {
    ...
    run: async (client, interaction, lang, runningCommand, execTimestamp, args) => {
        // Guard's Typing
