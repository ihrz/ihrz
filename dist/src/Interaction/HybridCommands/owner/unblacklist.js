...
*/
import { ApplicationCommandOptionType, ChatInputCommandInteraction, ApplicationCommandType } from 'discord.js';
export const command = {
    ...
    run: async (client, interaction, lang, command, neededPerm, args) => {
        ...
        ;
        try {
            let bannedMember = await client.users.fetch(member?.id);
            if (!bannedMember) {
