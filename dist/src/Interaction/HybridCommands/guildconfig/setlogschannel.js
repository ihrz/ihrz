...
*/
import { PermissionsBitField, ApplicationCommandOptionType, ChatInputCommandInteraction, ApplicationCommandType, ChannelType, PermissionFlagsBits, } from 'discord.js';
...
export const command = {
    ...
    run: async (client, interaction, lang, command, neededPerm, args) => {
        ...
        ;
        const createLogsChannel = async (name, typeOfLogs) => {
            if (!channel) {
