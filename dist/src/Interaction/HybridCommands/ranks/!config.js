...
*/
import { ChatInputCommandInteraction, EmbedBuilder, PermissionsBitField, ActionRowBuilder, ButtonBuilder, ButtonStyle, StringSelectMenuBuilder, StringSelectMenuOptionBuilder, RoleSelectMenuBuilder, TextInputStyle, ComponentType, Colors, } from 'discord.js';
    ...
    run: async (client, interaction, lang, command, neededPerm, args) => {
        ...
        collector.on('collect', async (interaction2) => {
            ...
            if (interaction2.customId === 'add_role') {
                ...
                if (!selectedRole)
                    return;
                let rolePermissions = new PermissionsBitField(selectedRole.permissions);
            ...
            if (interaction2.customId === 'remove_role') {
                ...
                const roleOptions = Object.entries(ranksConfig.ranksRoles || {}).map(([level, roleId]) => new StringSelectMenuOptionBuilder()
