...
module.exports = {
    ...
    run: async (client, interaction) => {
        ...
        let targetuser = await db.fetch(`money_${interaction.guild.id}_${user.id}`) // fetch mentioned users balance
        let author = await db.fetch(`money_${interaction.guild.id}_${interaction.user.id}`) // fetch authors balance
