...
exports.GiveawayMessages = {
    ...
    dropMessage: 'React with 🎉 to participate!',
    embedFooter: '{this.winnerCount} winner(s) - iHorizon',
    noWinner: 'Giveaway cancelled, no valid participations.',
    winners: 'iHorizon - Winner(s):',
    endedAt: 'iHorizon - Ended at',
...
exports.GiveawaysManagerOptions = {
    storage: `${process.cwd()}/files/giveaways.json`,
